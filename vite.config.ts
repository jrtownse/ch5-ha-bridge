...
export default (config: { mode: string; }) => {
  ...
  console.log(`Vite is running in mode: ${config.mode}`);
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          id: "/ch5-ha-bridge/",
          name: 'CH5 HomeAssistant Bridge',
          // Keep the short name 12 characters or less for mobile devices
          short_name: 'CH5 HA Bridge',
          description: 'Bind Crestron to HomeAssistant via MQTT.',
          theme_color: '#696969', 
